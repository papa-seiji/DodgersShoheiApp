...
public class OhtaniGameRepository {
     ...
     * ============================================
     */
    public Map<String, Object> getVsRightStatsByOpponent(
            String opponent,
            Integer season,
            String result) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsRightStatsByPitcher(
            String pitcher,
            Integer season) {
    ...
    public List<Map<String, Object>> getVsRightLogs(
        ...
        String sql = """
                ...
                FROM (
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa1_description LIKE '%Curve%'
                            AND d.pa1_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa2_description LIKE '%Curve%'
                            AND d.pa2_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa3_description LIKE '%Curve%'
                            AND d.pa3_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa4_description LIKE '%Curve%'
                            AND d.pa4_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa5_description LIKE '%Curve%'
                            AND d.pa5_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
                    ...
                    AND (
                        ...
                        OR (
                            CAST(? AS TEXT) = 'Curve'
                            AND d.pa6_description LIKE '%Curve%'
                            AND d.pa6_description NOT LIKE '%Knuckle Curve%'
                        )
                        OR (
                            CAST(? AS TEXT) <> 'BREAKING'
                            AND CAST(? AS TEXT) <> 'Curve'
        ...
        return jdbcTemplate.queryForList(
                ...
                pitchType, pitchType, pitchType, pitchType, pitchType, pitchType, pitchType,
     ...
     * ============================================
     */
    public Map<String, Object> getVsLeftStatsByPitcher(
            String pitcher,
            Integer season) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsLeftStatsByPitcherAndPitchType(
            String pitcher,
            String pitchType,
            Integer season,
            String result) {
    ...
    public List<Map<String, Object>> getVsLeftLogs(
        ...
        String sql = """
                ...
                FROM (
                    ...
                    SELECT g.game_date, g.opponent, d.pa1_pitcher AS pitcher, d.pa1_pitcher_hand AS hand, d.pa1_result AS result, d.pa1_description AS description
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
     ...
     * ============================================
     */
    public Map<String, Object> getVsAllStats(Integer season, String result, String opponent) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsAllStatsByOpponent(
            String opponent,
            Integer season,
            String result) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsAllStatsByPitcher(
            String pitcher,
            Integer season) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsAllStatsByPitchType(
            String result,
            String pitchType,
            Integer season,
            String opponent) {
     ...
     * ============================================
     */
    public Map<String, Object> getVsAllStatsByPitcherAndPitchType(
            String pitcher,
            String pitchType,
            Integer season,
            String result) {
    ...
    public List<Map<String, Object>> getVsAllLogs(
        ...
        String sql = """
                SELECT game_date, opponent, pitcher, hand, result, description, direction
                FROM (
    ...
    public Map<String, Integer> getHitDirectionStats(
        ...
        List<Map<String, Object>> rows = jdbcTemplate.queryForList(
                ...
                pitcher, pitcher, pitcher,
                pitchType, pitchType, pitchType, pitchType, pitchType, pitchType, pitchType, pitchType,
                speedMin, speedMax, speedMin, speedMax,
    ...
    public List<Map<String, Object>> getRispLogs(
        ...
        String sql = """
                    SELECT
                        ...
                        CASE
                            WHEN description LIKE '%Four-Seam%' THEN 'Four-Seam'
                            WHEN description LIKE '%Sinker%' THEN 'Sinker'
                            WHEN description LIKE '%Sweeper%' THEN 'Sweeper'
                            WHEN description LIKE '%Slider%' THEN 'Slider'
                            WHEN description LIKE '%Splitter%' THEN 'Splitter'
                            WHEN description LIKE '%Cutter%' THEN 'Cutter'
                            WHEN description LIKE '%Knuckle Curve%' THEN 'Knuckle Curve'
                            WHEN description LIKE '%Slurve%' THEN 'Slurve'
                            WHEN description LIKE '%Changeup%' THEN 'Changeup'
                            ELSE '-'
                        END AS "pitchType",
    ...
    public List<Map<String, Object>> getShoheiFavoritePitcherTopFive(
        ...
        String sql = """
                WITH pa AS (
                    ...
                    SELECT d.pa1_pitcher AS pitcher, d.pa1_pitcher_hand AS pitcher_hand, d.pa1_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa1_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                    ...
                    SELECT d.pa2_pitcher AS pitcher, d.pa2_pitcher_hand AS pitcher_hand, d.pa2_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa2_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                    ...
                    SELECT d.pa3_pitcher AS pitcher, d.pa3_pitcher_hand AS pitcher_hand, d.pa3_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa3_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                    ...
                    SELECT d.pa4_pitcher AS pitcher, d.pa4_pitcher_hand AS pitcher_hand, d.pa4_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa4_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                    ...
                    SELECT d.pa5_pitcher AS pitcher, d.pa5_pitcher_hand AS pitcher_hand, d.pa5_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa5_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                    ...
                    SELECT d.pa6_pitcher AS pitcher, d.pa6_pitcher_hand AS pitcher_hand, d.pa6_result AS result
                    FROM ohtani_game_details d
                    JOIN ohtani_games g ON d.game_id = g.id
                    WHERE d.pa6_pitcher IS NOT NULL
                      AND EXTRACT(YEAR FROM g.game_date) = ?
                ...
                SELECT
                    pitcher,
                    MIN(pitcher_hand) AS pitcher_hand,
                    SUM(CASE WHEN result IN ('HIT', 'HR') THEN 1 ELSE 0 END) AS hits,
                    SUM(CASE WHEN result NOT IN ('BB', 'SF') THEN 1 ELSE 0 END) AS at_bats,
                    SUM(CASE WHEN result = 'HR' THEN 1 ELSE 0 END) AS hr,
                    SUM(CASE WHEN result = 'BB' THEN 1 ELSE 0 END) AS bb,
