...
public class OhtaniScorebookController {
        ...
        public String showSeasonOverview(Model model) {
                ...
                Map<String, String> vsR = mlbGameService.getVsRightStatsFormatted(2026, null);
        ...
        public String showBattingFilter(
                ...
                if ("ALL".equals(opponent)) {
                        opponent = null;
                }

                if ("ALL".equals(pitchType)) {
                        pitchType = null;
                }
                ...
                if ("R".equals(hand)) {
                        ...
                        if (pitcher != null
                                ...
                                vsR = mlbGameService
                                                .getVsRightStatsFormatted(season, result);
                        }
                ...
                if ("L".equals(hand)) {
                        ...
                        if (pitcher != null
                                ...
                                vsL = mlbGameService
                                                .getVsLeftStatsFormatted(season, result);
                        }
                ...
                if ("R".equals(hand)) {
                        ...
                        directionStats = mlbGameService
                                        .getHitDirectionStatsByRight(season, result, opponent);

                } else if ("L".equals(hand)) {

                        directionStats = mlbGameService
                                        .getHitDirectionStatsByLeft(season, result);
